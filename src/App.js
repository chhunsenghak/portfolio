...
export default function App() {
  ...
  useEffect(() => {
    ...
    function tick() {
      ...
      if (!del.current) {
        ci.current++;
        setTyped(cur.substring(0, ci.current));
      } else {
        ci.current--;
        setTyped(cur.substring(0, ci.current));
      }
  ...
  // Initialize EmailJS with your public key (set REACT_APP_EMAILJS_USER_ID)
  useEffect(() => {
    const userId = process.env.REACT_APP_EMAILJS_USER_ID || "YOUR_PUBLIC_KEY";
    if (userId) emailjs.init(userId);
  }, []);

  const ip = {
    onMouseEnter: onHovIn,
    onMouseLeave: onHovOut,
    form: {
      values: formValues,
  ...
  const handleSendEmail = () => {
    const templateParams = {
      ...
      email: formValues.emailAddress || formValues.email || "",
      subject: formValues.subject || "",
      message: formValues.message || "",
    };

    const serviceId =
      process.env.REACT_APP_EMAILJS_SERVICE_ID || "service_gck15v5";
    const templateId =
      process.env.REACT_APP_EMAILJS_TEMPLATE_ID || "template_fu6km1o";
    const publicKey =
      process.env.REACT_APP_EMAILJS_USER_ID || "lczSPiqSMKgMaxgG3";
    ...
    >
      ...
      >
        <div
          style={{
            position: "absolute",
            inset: 0,
            background: `radial-gradient(ellipse at 30% 50%,rgba(59,130,246,.07),transparent 55%),radial-gradient(ellipse at 70% 50%,rgba(139,92,246,.05),transparent 55%)`,
          }}
        />
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          >
            I build beautiful, fast, and accessible web experiences that users
            love and developers enjoy maintaining.
          </motion.p>
          ...
          >
            <HeroBtn href="#projects" primary {...ip}>
              View My Work
            </HeroBtn>
            <HeroBtn href="#contact" {...ip}>
              Get In Touch
            </HeroBtn>
          </motion.div>
        </div>
      ...
      <section id="about" style={S.section()}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <Reveal>
            <div style={S.secLabel}>Who I Am</div>
          </Reveal>
          <Reveal>
          ...
          >
            <Reveal dir={isMobile ? "up" : "left"}>
              <div
                style={{ position: "relative", width: 160, margin: "0 auto" }}
              >
                <motion.div
                  animate={{ rotate: 360 }}
                  transition={{
                ...
                <div
                  style={{
                    ...
                    height: 160,
                    borderRadius: "50%",
                    background: `linear-gradient(135deg,${C.accent},${C.violet},${C.accent}88)`,
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    fontSize: 48,
            ...
            <Reveal dir={isMobile ? "up" : "right"}>
              ...
              >
                ...
                crafting responsive, user-centric web applications. I specialize
      ...
      <section id="skills" style={S.section(true)}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <Reveal>
            <div style={S.secLabel}>What I Know</div>
          </Reveal>
          <Reveal>
      ...
      <section id="projects" style={S.section()}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <Reveal>
            <div style={S.secLabel}>What I Built</div>
          </Reveal>
          <Reveal>
            ...
            >
              {[
                ...
                },
                {
                  key: "personal",
                  label: "✦ Personal",
                  count: projectsData.filter((p) => p.type === "personal")
                    .length,
                },
                {
                  key: "team",
                  label: "⚡ Team",
                  count: projectsData.filter((p) => p.type === "team").length,
                },
              ].map(({ key, label, count }) => {
      ...
      <section id="experience" style={S.section(true)}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <Reveal>
            <div style={S.secLabel}>Where I've Worked</div>
          </Reveal>
          <Reveal>
          ...
          <div style={{ position: "relative", paddingLeft: 32 }}>
            <div
              style={{
                ...
                bottom: 0,
                width: 1,
                background: `linear-gradient(180deg,${C.accent},${C.violet},transparent)`,
                opacity: 0.35,
              }}
            />
      ...
      <section id="education" style={S.section()}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <Reveal>
            <div style={S.secLabel}>My Background</div>
          </Reveal>
          <Reveal>
      ...
      <section id="certifications" style={S.section(true)}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <Reveal>
            <div style={S.secLabel}>Proof of Skills</div>
          </Reveal>
          <Reveal>
      ...
      <section id="contact" style={S.section()}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <Reveal>
            <div style={S.secLabel}>Let's Talk</div>
          </Reveal>
          <Reveal>
            <h2 style={S.secTitle}>Get In Touch</h2>
          </Reveal>
          <Reveal>
            <div style={S.divider} />
          </Reveal>
          <Reveal>
            ...
            >
              {[
                [C.accent, "senghakchhun1414@gmail.com"],
                [C.green, "+855 (096) 395-5091"],
                [C.gold, "Phnom Penh, Cambodia"],
              ].map(([col, txt]) => (
                <div
                  key={txt}
                  style={{
          ...
          <Reveal>
            <div style={{ ...S.card, maxWidth: 600, margin: "0 auto" }}>
              ...
              {[
                ["Email Address", "botveha@gmail.com"],
